...
func CheckIamSSHKeyExists(tt *tests.TestTools, n string) resource.TestCheckFunc {
...
func CheckIamSSHKeyDestroy(tt *tests.TestTools) resource.TestCheckFunc {
...
func CheckInstanceIPExists(tt *tests.TestTools, name string) resource.TestCheckFunc {
	return func(s *terraform.State) error {
